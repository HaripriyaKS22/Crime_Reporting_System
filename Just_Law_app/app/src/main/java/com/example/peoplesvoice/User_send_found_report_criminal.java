...
public class User_send_found_report_criminal extends Activity implements JsonResponse
{
    Button b1;
    EditText e1,e2;
    ListView l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_send_found_report_criminal);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                else if(details.equalsIgnoreCase(""))
                {
                    ...
                    JR.json_response=(JsonResponse) User_send_found_report_criminal.this;
        ...
        JsonReq JR=new JsonReq();
        JR.json_response=(JsonResponse) User_send_found_report_criminal.this;
        String q = "/User_send_found_report_criminal?mp_ids="+User_view_wanted_criminals.crm_ids;
        q=q.replace(" ","%20");
        JR.execute(q);
    }
        ...
        try{
            ...
            if(method.equalsIgnoreCase("user_send_found_report")){
                ...
                if(status.equalsIgnoreCase("success")){
                    ...
                    startActivity(new Intent(getApplicationContext(),User_send_found_report_criminal.class));
                }
                else
                {
            ...
            if(method.equalsIgnoreCase("User_send_found_report_criminal")){
                String status=jo.getString("status");
                Log.d("pearl",status);
...
//                    found_id=new String[ja1.length()];
                    ...
                    {
//                        found_id[i]=ja1.getJSONObject(i).getString("criminal_alert_id ");
                        place[i]=ja1.getJSONObject(i).getString("found_place");
                        dtls[i]=ja1.getJSONObject(i).getString("status");
