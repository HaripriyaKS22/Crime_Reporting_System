...
//        t3=(TextView)findViewById(R.id.tvtravel);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
		        ...
		        String q = "/login?username="+uname+"&password="+pass+"&latti="+LocationService.lati+"&logi=" +LocationService.logi;
		        q=q.replace(" ","%20");
		        JR.execute(q);
				}
	...
	public void response(JSONObject jo) {
		...
		try {
			...
			if(status.equalsIgnoreCase("success")){
				...
				else if(usertype.equals("vehicle"))
				{


					Toast.makeText(getApplicationContext()," You are Login Successfully!...,",Toast.LENGTH_LONG).show();
					startActivity(new Intent(getApplicationContext(),Vehicle_home.class));
